...
2. OPTIONAL, but recommended: install [Developer Console](https://github.com/FINDarkside/TLD-Developer-Console) mod. This will let you save anywhere, teleport, fly, toggle god & ghost modes, set time of day etc. which make it much easier when you're gathering data/testing mods.
